<?php declare(strict_types=1);
    ...
    function saveVisitedPath()
    {
        ...
        $select =
            ...
            . " FROM " . getNomeTabella( CONFIG_ISTANCE->get('TABLEPREFIX'), TableNames::PATHVISITATED)
        ...
        if( $row ){
            $update =
                "UPDATE " . getNomeTabella(CONFIG_ISTANCE->get('TABLEPREFIX'), TableNames::PATHVISITATED)
            ...
            $insert =
                "INSERT INTO " . getNomeTabella(CONFIG_ISTANCE->get('TABLEPREFIX'), TableNames::PATHVISITATED)
