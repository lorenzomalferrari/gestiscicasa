                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card map-area">
                                <div class="card-body">
                                    <h3 class="text-midnight text-bold text-22 mb-sm-5 mb-3">Vector World Map Marker</h3>
                                    <div class="world-vmap" id="world-map-markers"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="card map-area">
                                <div class="card-body">
                                    <h3 class="text-midnight text-bold text-22 mb-sm-5 mb-3">Vector World GDP Map</h3>
                                    <div class="world-vmap" id="world-map-gdp"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="card map-area">
                                <div class="card-body">
                                    <h3 class="text-midnight text-bold text-22 mb-sm-5 mb-3">Vector World Map without Marker</h3>
                                    <div class="world-vmap" id="world-map"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="card map-area">
                                <div class="card-body">
                                    <h3 class="text-midnight text-bold text-22 mb-sm-5 mb-3">Vector Region Map</h3>
                                    <div class="world-vmap" id="world-map2"></div>
                                </div>
                            </div>
                        </div>
                    </div>
