...
<head>
    ...
    <title>Privacy Policy - [Nome del Gestionale]</title>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <p>Benvenuti alla Privacy Policy di <strong>[Nome del Gestionale]</strong>. Questa Privacy Policy spiega come raccogliamo, utilizziamo, proteggiamo e condividiamo le informazioni personali degli utenti che utilizzano il nostro gestionale.</p>
        ...
        <ul>
            ...
            <li><strong>Dati Non Personali:</strong> Informazioni tecniche, dati di utilizzo, cookie, ecc.</li>
        </ul>
        ...
        <ul>
            ...
            <li><strong>Automaticamente:</strong> Attraverso l'uso del gestionale, inclusi dati tecnici e cookie.</li>
        </ul>
        ...
        <p>Adottiamo misure di sicurezza appropriate per proteggere le informazioni degli utenti. Tuttavia, nessun sistema è completamente sicuro e non possiamo garantire la sicurezza assoluta dei dati.</p>
        ...
        <p><strong>Data di efficacia:</strong> [Inserisci Data]</p>
