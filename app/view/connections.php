                        ...
                        <div class="col-xl-8 col-xxl-9">
                            <div class="connections-page">
                                ...
                                <div class="heading-area">
                                    <div class="row align-items-center">
                                        <div class="col-md-4">
                                            <h4 class="text-body text-xtrabold text-md-left text-center">Our Connections</h4>
                                        </div>
                                        <div class="col-md-8 d-flex justify-content-md-end justify-content-center">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab" href="#followers" role="tab" aria-selected="true">
                                                        Followers <span>548</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#following" role="tab" aria-selected="false">
                                                        Following <span>345</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#request" role="tab" aria-selected="false">
                                                        Request <span>47</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xxl-4 col-md-6">
                                                <div class="connection-box">
                                                    <div class="item-img">
                                                        <img src="media/figure/img_21.jpg" alt="Thumb">
                                                    </div>
                                                    <div class="item-content">
                                                        <h3 class="item-title">Jack Lewinski</h3>
                                                        <div class="item-designation">Web Developer</div>
                                                        <div class="item-company">Abteck It Company Ltd.</div>
                                                        <div class="social-area">
                                                            ...
                                                            <div class="btn-wrap">
                                                                <a href="#" class="item-btn">Follow</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xxl-4 col-md-6">
                                                <div class="connection-box">
                                                    <div class="item-img">
                                                        <img src="media/figure/img_22.jpg" alt="Thumb">
                                                    </div>
                                                    <div class="item-content">
                                                        <h3 class="item-title">Lessie Ballard </h3>
                                                        <div class="item-designation">Senior Interior</div>
                                                        <div class="item-company">Abteck It Company Ltd.</div>
                                                        <div class="social-area">
                                                            <div class="social-icon">
                                                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            ...
                                            <div class="col-xxl-4 col-md-6">
                                                <div class="connection-box">
                                                    <div class="item-img">
                                                        <img src="media/figure/img_23.jpg" alt="Thumb">
                                                    </div>
                                                    <div class="item-content">
                                                        <h3 class="item-title">Dorothy Brinton</h3>
                                                        <div class="item-designation">Manager</div>
                                                        <div class="item-company">Abteck It Company Ltd.</div>
                                                        <div class="social-area">
                                                            <div class="social-icon">
                                                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            ...
                                            <div class="col-xxl-4 col-md-6">
                                                <div class="connection-box">
                                                    <div class="item-img">
                                                        <img src="media/figure/img_24.jpg" alt="Thumb">
                                                    </div>
                                                    <div class="item-content">
                                                        <h3 class="item-title">Rose Crane</h3>
                                                        <div class="item-designation">App Developer</div>
                                                        <div class="item-company">Abteck It Company Ltd.</div>
                                                        <div class="social-area">
                                                            <div class="social-icon">
                                                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            ...
                                            <div class="col-xxl-4 col-md-6">
                                                <div class="connection-box">
                                                    <div class="item-img">
                                                        <img src="media/figure/img_25.jpg" alt="Thumb">
                                                    </div>
                                                    <div class="item-content">
                                                        <h3 class="item-title">Laverne Andersen</h3>
                                                        <div class="item-designation">Interior Design</div>
                                                        <div class="item-company">Abteck It Company Ltd.</div>
                                                        <div class="social-area">
                                                            <div class="social-icon">
                                                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            ...
                                            <div class="col-xxl-4 col-md-6">
                                                <div class="connection-box">
                                                    <div class="item-img">
                                                        <img src="media/figure/img_26.jpg" alt="Thumb">
                                                    </div>
                                                    <div class="item-content">
                                                        <h3 class="item-title">Emilie Reyes</h3>
                                                        <div class="item-designation">Designer</div>
                                                        <div class="item-company">Abteck It Company Ltd.</div>
                                                        <div class="social-area">
                                                            <div class="social-icon">
                                                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                            ...
                            <div class="connection-widget">
                                <div class="widget">
                                    <div class="widget-people">
                                        <h6 class="text-body text-bold mb-4">PEOPLE YOU MAY KNOW</h6>
                                        <div class="people-list">
                                            <a href="#" class="media">
                                                <div class="item-img">
                                                    <img src="media/figure/img_16.jpg" alt="Thumb">
                                                </div>
                                                <div class="media-body">
                                                    <h5 class="item-title text-bold mb-0">Sophia Ribeiro</h5>
                                                    <div class="text-bombay">Senior Interior</div>
                                                </div>
                                            </a>
                                            <a href="#" class="media">
                                                <div class="item-img">
                                                    <img src="media/figure/img_17.jpg" alt="Thumb">
                                                </div>
                                                <div class="media-body">
                                                    <h5 class="item-title text-bold mb-0">Frank Tyson</h5>
                                                    <div class="text-bombay">Designer</div>
                                                </div>
                                            </a>
                                            <a href="#" class="media">
                                                <div class="item-img">
                                                    <img src="media/figure/img_18.jpg" alt="Thumb">
                                                </div>
                                                <div class="media-body">
                                                    <h5 class="item-title text-bold mb-0">Frank Tyson</h5>
                                                    <div class="text-bombay">Designer</div>
                                            ...
                                            <a href="#" class="media">
                                                <div class="item-img">
                                                    <img src="media/figure/img_19.jpg" alt="Thumb">
                                                </div>
                                                <div class="media-body">
                                                    <h5 class="item-title text-bold mb-0">Clarence D. Ryan</h5>
                                                    <div class="text-bombay">Support Engineer</div>
                                                </div>
                                            </a>
                                            <a href="#" class="media">
                                                <div class="item-img">
                                                    <img src="media/figure/img_20.jpg" alt="Thumb">
                                                </div>
                                                <div class="media-body">
                                                    <h5 class="item-title text-bold mb-0">Edith T. Painter</h5>
                                                    <div class="text-bombay">Support Engineer</div>
                                                </div>
                                            </a>
                                        </div>
