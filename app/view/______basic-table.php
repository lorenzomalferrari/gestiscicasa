            ...
            <div class="dsy-page-content vertical-menu">
                ...
                <div class="container-fluid">
                    <div class="card component-table">
                        <div class="card-body">
                            <h3 class="text-body text-22 text-bold mb-4">Basic Table</h3>
                    ...
                    <div class="card component-table">
                        <div class="card-body">
                            <h3 class="text-body text-22 text-bold mb-4">Borderless Table</h3>
                            <div class="table-responsive">
                    ...
                    <div class="card component-table">
                        <div class="card-body">
                            <h3 class="text-body text-22 text-bold mb-4">Dark Table</h3>
                            <div class="table-responsive">
                    ...
                    <div class="card component-table">
                        <div class="card-body">
                            <h3 class="text-body text-22 text-bold mb-4">Stripped Table</h3>
                            <div class="table-responsive">
                    ...
                    <div class="card component-table">
                        <div class="card-body">
                            <h3 class="text-body text-22 text-bold mb-4">Stripped Dark Table</h3>
                            <div class="table-responsive">
                    ...
                    <div class="card component-table">
                        <div class="card-body">
                            <h3 class="text-body text-22 text-bold mb-4">Hoverable Table</h3>
                            <div class="table-responsive">
                    ...
                    <div class="card component-table">
                        <div class="card-body">
                            <h3 class="text-body text-22 text-bold mb-4">Table With Contextual Classes</h3>
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                    ...
                    <div class="card component-table">
                        <div class="card-body">
                            <h3 class="text-body text-22 text-bold mb-4">Table With Captions</h3>
                            <div class="table-responsive">
                                <table class="table">
                                    <caption>Table With Captions</caption>
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>FIRST NAME</th>
