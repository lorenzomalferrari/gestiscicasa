...
<head>
    ...
    <title>Dashy | Discover Events</title>
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        <div class="events-box">
                                            ...
                                            <div class="item-content">
                                                <div class="item-date">
                                                    <i class="far fa-calendar-alt"></i> Mar 22 - Mar 24
                                                </div>
                                                <h4 class="item-title"><a href="#">Business Events 2020</a></h4>
                                                <div class="item-location"><i class="fas fa-map-marker-alt"></i> Bay Area, San Francisco, CA</div>
                                                <div class="btn-area">
                                                    <div class="people-count">
                                                        4,245 people interested
                                                    </div>
                                                    <div class="btn-wrap">
                                                        <a href="#" class="item-btn">Interested</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        <div class="events-box">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <h4 class="item-title"><a href="#">Technology Confrence ‘20</a></h4>
                                                <div class="item-location"><i class="fas fa-map-marker-alt"></i> Bay Area, San Francisco, CA</div>
                                                <div class="btn-area">
                                                    <div class="people-count">
                                                        4,245 people interested
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        <div class="events-box">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <h4 class="item-title"><a href="#">Fashion Carnival 2020<</a> </h4> <div class="item-location"><i class="fas fa-map-marker-alt"></i> Bay Area, San Francisco, CA
                                            </div>
                                            <div class="btn-area">
                                                <div class="people-count">
                                                    4,245 people interested
                                ...
                                <div class="col-md-6 col-xxl-4">
                                    <div class="events-box">
                                        ...
                                        <div class="item-content">
                                            ...
                                            <h4 class="item-title"><a href="#">Eventchamp Conference</a></h4>
                                            <div class="item-location"><i class="fas fa-map-marker-alt"></i> Bay Area, San Francisco, CA</div>
                                            <div class="btn-area">
                                                <div class="people-count">
                                                    4,245 people interested
                                ...
                                <div class="col-md-6 col-xxl-4">
                                    <div class="events-box">
                                        ...
                                        <div class="item-content">
                                            ...
                                            <h4 class="item-title"><a href="#">CA After Party</a></h4>
                                            <div class="item-location"><i class="fas fa-map-marker-alt"></i> Bay Area, San Francisco, CA</div>
                                            <div class="btn-area">
                                                <div class="people-count">
                                                    4,245 people interested
                                ...
                                <div class="col-md-6 col-xxl-4">
                                    <div class="events-box">
                                        ...
                                        <div class="item-content">
                                            ...
                                            <h4 class="item-title"><a href="#">Soccer Cup Final 2021</a></h4>
                                            <div class="item-location"><i class="fas fa-map-marker-alt"></i> Bay Area, San Francisco, CA</div>
                                            <div class="btn-area">
                                                <div class="people-count">
                                                    4,245 people interested
                                ...
                                <div class="col-md-6 col-xxl-4">
                                    <div class="events-box">
                                        ...
                                        <div class="item-content">
                                            ...
                                            <h4 class="item-title"><a href="#">Wedding James &amp; Helen</a></h4>
                                            <div class="item-location"><i class="fas fa-map-marker-alt"></i> Bay Area, San Francisco, CA</div>
                                            <div class="btn-area">
                                                <div class="people-count">
                                                    4,245 people interested
                                ...
                                <div class="col-md-6 col-xxl-4">
                                    <div class="events-box">
                                        ...
                                        <div class="item-content">
                                            ...
                                            <h4 class="item-title"><a href="#">Drama Games 2020</a></h4>
                                            <div class="item-location"><i class="fas fa-map-marker-alt"></i> Bay Area, San Francisco, CA</div>
                                            <div class="btn-area">
                                                <div class="people-count">
                                                    4,245 people interested
                        ...
                        <div class="connection-widget">
                            <div class="widget">
                                <div class="widget-people">
                                    <h6 class="text-body text-bold mb-4">UPCOMING EVENTS</h6>
                                    <div class="people-list">
                                        <a href="#" class="media">
                                            ...
                                            <div class="media-body">
                                                <h5 class="item-title text-bold mb-0">Today Birthday</h5>
                                                <div class="text-bombay">Today, April 21, 5:00pm</div>
                                            </div>
                                        </a>
                                        <a href="#" class="media">
                                            <div class="item-img">
                                            ...
                                            <div class="media-body">
                                                <h5 class="item-title text-bold mb-0">Envato Meetup</h5>
                                                <div class="text-bombay">April 25, 12:00pm</div>
                                            </div>
                                        </a>
                                        <a href="#" class="media">
                                            <div class="item-img">
                                            ...
                                            <div class="media-body">
                                                <h5 class="item-title text-bold mb-0">Devlop Conference</h5>
                                                <div class="text-bombay">April 27, 2:00pm</div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="widget">
                                <div class="widget-discover">
                                    ...
                                    <ul class="discover-list">
                                        <li>
                                            <a href="#">Worldwide<span>20</span> </a>
                                        </li>
                                        <li>
                                            <a href="#">Asia Pacific<span>18</span> </a>
                                        </li>
                                        <li>
                                            <a href="#">United States<span>14</span> </a>
                                        </li>
                                        <li>
                                            <a href="#">Europe<span>12</span> </a>
                                        </li>
                                        <li>
                                            <a href="#">Nearby<span>10</span> </a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
