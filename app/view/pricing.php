...
<head>
    ...
    <title>Dashy | Pricing Plan</title>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="pricing-box">
                                    ...
                                    <h2 class="item-title">BASIC PLAN</h2>
                                    ...
                                    <a href="#" class="item-btn">Choose Plan</a>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="pricing-box">
                            ...
                            <div class="col-lg-4">
                                <div class="pricing-box">
                                    ...
                                    <h2 class="item-title">CORPORATE</h2>
                                    <p>There are many variations of passages of Lorem Ipsum available but the majority is have suffered alteration in that some form by injected humour or randomised words which don't look even slightly.</p>
