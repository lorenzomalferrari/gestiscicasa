    ...
    <div id="main-wrapper" class="dsy-main-wrapper">
        <div class="dsy-page">
            ...
            <div class="dsy-page-content vertical-menu">
                ...
                <!--=====================================-->
                <div class="container-fluid">
                    <div class="card ui-badge">
                        <div class="card-body">
                            <h3 class="text-22 text-body text-bold mg-b-30">Default Badge</h3>
                            ...
                            <div class="mt-5 mb-4 text-15">Badges can be used as part of links or buttons to provide a counter.</div>
                    ...
                    <div class="card ui-badge">
                        <div class="card-body">
                            <h3 class="text-22 text-body text-bold mg-b-30">Contextual variations</h3>
                    ...
                    <div class="card ui-badge">
                        <div class="card-body">
                            <h3 class="text-22 text-body text-bold mg-b-30">Pill Badges</h3>
                    ...
                    <div class="card ui-badge">
                        <div class="card-body">
                            <h3 class="text-22 text-body text-bold mg-b-30">Link Badges</h3>
