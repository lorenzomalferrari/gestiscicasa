...
<head>
    ...
    <title>Dashy | File Manager</title>
        ...
        <div class="dsy-page">
            ...
            <div class="dsy-page-content vertical-menu">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card file-manager-aside">
                                <div class="card-body">
                                    <div class="side-category">
                                        <label>MY DRIVE</label>
                                        <ul class="menu-list">
                                            <li>
                                                <a href="#" class="menu-link active"><i class="flaticon-folder"></i>All Files</a>
                                            </li>
                                            <li>
                                                <a href="#" class="menu-link"><i class="flaticon-television"></i>My Devices</a>
                                            </li>
                                            <li>
                                                <a href="#" class="menu-link"><i class="flaticon-clock"></i>Recents</a>
                                            </li>
                                            <li>
                                                <a href="#" class="menu-link"><i class="flaticon-star"></i>Importent</a>
                                            </li>
                                            <li>
                                                <a href="#" class="menu-link"><i class="flaticon-delete"></i>Deleted Files</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="side-category">
                                        ...
                                        <ul class="menu-list">
                                            <li>
                                                <a href="#" class="menu-link"><i class="flaticon-null-4"></i>Documents</a>
                                            </li>
                                            <li>
                                                <a href="#" class="menu-link"><i class="flaticon-image"></i>Images</a>
                                            </li>
                                            <li>
                                                <a href="#" class="menu-link"><i class="flaticon-video-camera"></i>Videos</a>
                                            </li>
                                            <li>
                                                <a href="#" class="menu-link"><i class="flaticon-headphone"></i>Audio</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="side-category">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="item-title">17.5GB used of 50GB</h6>
                                                <div class="progress">
                                                    <div class="progress-bar" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                                <a href="#" class="upgrade-btn">Upgrade Storage</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-8">
                            <div class="file-manager">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-sm-6">
                                            <div class="heading-btn">
                                                <a href="#"><i class="flaticon-plus"></i>CREATE</a>
                                                <a href="#"><i class="flaticon-export"></i>UPLOAD</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="quick-file">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            <h4 class="text-body text-xtrabold mb-1">Files</h4>
                                            <h5 class="text-15 text-body text-semibold mb-3">Quick Access</h5>
                                        </div>
                                        <div class="col-6">
                                            <h5 class="text-15 text-bold text-right"><a href="#" class="text-body">Hide</a></h5>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                <div class="dismis-btn">
                                                    <button><i class="fas fa-times"></i></button>
                                                </div>
                                                <div class="item-img">
                                                    <img src="media/figure/folder_1.png" alt="Folder">
                                                </div>
                                                <h5 class="item-title"><a href="#">Web Design</a></h5>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                ...
                                                <h5 class="item-title"><a href="#">Project Work</a></h5>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                ...
                                                <div class="item-img">
                                                    <img src="media/figure/folder_2.png" alt="Folder">
                                                </div>
                                                <h5 class="item-title"><a href="#">Presentation</a></h5>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                ...
                                                <div class="item-img">
                                                    <img src="media/figure/folder_3.png" alt="Folder">
                                                </div>
                                                <h5 class="item-title"><a href="#">PDF Files</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="browse-file">
                                    <div class="item-heading">
                                        <div class="row">
                                            <div class="col-6">
                                                <h4 class="text-body text-semibold text-15">Browse Files</h4>
                                            </div>
                                            <div class="col-6">
                                                <div class="dropdown text-right mr-0">
                                        ...
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                <div class="dropdown text-right">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="#"><i class="fas fa-info-circle"></i>View Details</a>
                                                        <a class="dropdown-item" href="#"><i class="fas fa-upload"></i>Share</a>
                                                        <a class="dropdown-item" href="#"><i class="fas fa-download"></i>Download</a>
                                                        <a class="dropdown-item" href="#"><i class="fas fa-layer-group"></i>Copy to</a>
                                                        <a class="dropdown-item" href="#"><i class="fas fa-folder-open"></i>Move to</a>
                                                        <a class="dropdown-item" href="#"><i class="fas fa-edit"></i>Rename</a>
                                                        <a class="dropdown-item" href="#"><i class="fas fa-trash-alt"></i>Delete</a>
                                                    </div>
                                                </div>
                                                <div class="item-img">
                                                    <img src="media/figure/folder_4.png" alt="Folder">
                                                </div>
                                                <h5 class="item-title"><a href="#">Proposal</a></h5>
                                                <div class="text-12 text-regent-gray">Today. 7.3 MB</div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                ...
                                                <div class="item-img">
                                                    <img src="media/figure/folder_5.png" alt="Folder">
                                                </div>
                                                <h5 class="item-title"><a href="#">Project Work</a></h5>
                                                <div class="text-12 text-regent-gray">Today. 15.2 MB</div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                ...
                                                <h5 class="item-title"><a href="#">Project 2018</a></h5>
                                                <div class="text-12 text-regent-gray">Today. 1.5 GB</div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                ...
                                                <h5 class="item-title"><a href="#">Presentation</a></h5>
                                                <div class="text-12 text-regent-gray">07 Jun. 225 MB</div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                ...
                                                <h5 class="item-title"><a href="#">PDF Files</a></h5>
                                                <div class="text-12 text-regent-gray">05 Jun. 175 MB</div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                ...
                                                <div class="item-img">
                                                    <img src="media/figure/folder_6.png" alt="Folder">
                                                </div>
                                                <h5 class="item-title"><a href="#">Works Files</a></h5>
                                                <div class="text-12 text-regent-gray">04 Jun. 384 MB</div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                ...
                                                <div class="item-img">
                                                    <img src="media/figure/folder_7.png" alt="Folder">
                                                </div>
                                                <h5 class="item-title"><a href="#">IMG_063037.jpg</a></h5>
                                                <div class="text-12 text-regent-gray">03 Jun. 4.1 MB</div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                ...
                                                <h5 class="item-title"><a href="#">IMG_063040.jpg</a></h5>
                                                <div class="text-12 text-regent-gray">03 Jun. 4.1 MB</div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                ...
                                                <h5 class="item-title"><a href="#">IMG_063043.jpg</a></h5>
                                                <div class="text-12 text-regent-gray">03 Jun. 4.1 MB</div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                ...
                                                <h5 class="item-title"><a href="#">IMG_063050.jpg</a></h5>
                                                <div class="text-12 text-regent-gray">03 Jun. 4.1 MB</div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-4 col-6">
                                            <div class="file-folder">
                                                ...
                                                <h5 class="item-title"><a href="#">IMG_063055.jpg</a></h5>
                                                <div class="text-12 text-regent-gray">03 Jun. 4.1 MB</div>
                                            </div>
                                        </div>
                                    </div>
