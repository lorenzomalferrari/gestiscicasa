...
<head>
    ...
    <title>Dashy | Contact Grid</title>
    ...
    <div id="main-wrapper" class="dsy-main-wrapper">
        <div class="dsy-page">
            ...
            <div class="dsy-page-content vertical-menu">
                ...
                <!--=         Breadcrumb Start          =-->
                <!--=====================================-->
                <div class="breadcrumbs-wrap pb-2">
                    ...
                    <div class="contact-apps">
                        <div class="contact-heading">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <div class="add-btn">
                                        <a href="#"><i class="flaticon-plus"></i>ADD NEW</a>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="dropdown text-right">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="contact-list.php">User List</a>
                                            <a class="dropdown-item" href="contact.php">User Grid</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                                ...
                                <div class="contact-box">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="#"><i class="fas fa-user-plus"></i>Add People</a>
                                            <a class="dropdown-item" href="#"><i class="fas fa-trash-alt"></i>Delete</a>
                                        </div>
                                    </div>
                                    <div class="item-img">
                                        <img src="media/figure/contact_1.jpg" alt="Folder">
                                    </div>
                                    <h5 class="item-title">Katja Simenson</h5>
                                    ...
                                    <ul class="action-area">
                                        ...
                                        <li><a href="#"><i class="fas fa-chart-pie"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xl-4 col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <div class="item-img">
                                        <img src="media/figure/contact_2.jpg" alt="Folder">
                                    </div>
                                    <h5 class="item-title">John Balmer</h5>
                                    <div class="item-subtitle">Senior Interior</div>
                                    <ul class="contact-location">
                                        <li><i class="fas fa-map-marker-alt"></i>New York, USA</li>
                                        <li><i class="fas fa-phone"></i>+1 123 456 789</li>
                                    </ul>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <div class="item-img">
                                        <img src="media/figure/contact_3.jpg" alt="Folder">
                                    </div>
                                    <h5 class="item-title">Marry Scott</h5>
                                    <div class="item-subtitle">Planning Manager</div>
                                    <ul class="contact-location">
                                        <li><i class="fas fa-map-marker-alt"></i>New York, USA</li>
                                        <li><i class="fas fa-phone"></i>+1 123 456 789</li>
                                    </ul>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <div class="item-img">
                                        <img src="media/figure/contact_4.jpg" alt="Folder">
                                    </div>
                                    <h5 class="item-title">Joseph Smith</h5>
                                    <div class="item-subtitle">Project Manager</div>
                                    <ul class="contact-location">
                                        <li><i class="fas fa-map-marker-alt"></i>New York, USA</li>
                                        <li><i class="fas fa-phone"></i>+1 123 456 789</li>
                                    </ul>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <div class="item-img">
                                        <img src="media/figure/contact_5.jpg" alt="Folder">
                                    </div>
                                    <h5 class="item-title">Steve Cook</h5>
                                    <div class="item-subtitle">Developer</div>
                                    <ul class="contact-location">
                                        <li><i class="fas fa-map-marker-alt"></i>New York, USA</li>
                                        <li><i class="fas fa-phone"></i>+1 123 456 789</li>
                                    </ul>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <div class="item-img">
                                        <img src="media/figure/contact_6.jpg" alt="Folder">
                                    </div>
                                    <h5 class="item-title">Paula James</h5>
                                    <div class="item-subtitle">Architecture Head</div>
                                    <ul class="contact-location">
                                        <li><i class="fas fa-map-marker-alt"></i>New York, USA</li>
                                        <li><i class="fas fa-phone"></i>+1 123 456 789</li>
                                    </ul>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <div class="item-img">
                                        <img src="media/figure/contact_7.jpg" alt="Folder">
                                    </div>
                                    <h5 class="item-title">Gina Bruno</h5>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <div class="item-img">
                                        <img src="media/figure/contact_8.jpg" alt="Folder">
                                    </div>
                                    <h5 class="item-title">David Ferry</h5>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <div class="item-img">
                                        <img src="media/figure/contact_9.jpg" alt="Folder">
                                    </div>
                                    <h5 class="item-title">Regina Blackly</h5>
                                    <div class="item-subtitle">General Manager</div>
                                    <ul class="contact-location">
                                        <li><i class="fas fa-map-marker-alt"></i>New York, USA</li>
                                        <li><i class="fas fa-phone"></i>+1 123 456 789</li>
                                    </ul>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <div class="item-img">
                                        <img src="media/figure/contact_10.jpg" alt="Folder">
                                    </div>
                                    <h5 class="item-title">Robert Cooper</h5>
                                    <div class="item-subtitle">WEB Developer</div>
                                    <ul class="contact-location">
                                        <li><i class="fas fa-map-marker-alt"></i>New York, USA</li>
                                        <li><i class="fas fa-phone"></i>+1 123 456 789</li>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <div class="item-img">
                                        <img src="media/figure/contact_11.jpg" alt="Folder">
                                    </div>
                                    <h5 class="item-title">Olivia Chee</h5>
                                    <div class="item-subtitle">CTO of Company</div>
                                    <ul class="contact-location">
                                        <li><i class="fas fa-map-marker-alt"></i>New York, USA</li>
                                        <li><i class="fas fa-phone"></i>+1 123 456 789</li>
                                    </ul>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <div class="item-img">
                                        <img src="media/figure/contact_12.jpg" alt="Folder">
                                    </div>
                                    <h5 class="item-title">Mark Porter</h5>
                                    <div class="item-subtitle">Head of Content</div>
                                    <ul class="contact-location">
                                        <li><i class="fas fa-map-marker-alt"></i>New York, USA</li>
                                        <li><i class="fas fa-phone"></i>+1 123 456 789</li>
                                    </ul>
