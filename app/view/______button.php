        ...
        <div class="dsy-page">
            ...
            <div class="dsy-page-content vertical-menu">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card ui-button-area">
                                <div class="card-body">
                                    <h3 class="text-body text-22 text-bold mg-b-30">Filled Button</h3>
                                    <button type="button" class="btn btn-primary">PRIMARY</button>
                                    <button type="button" class="btn btn-secondary">SECONDARY</button>
                                    <button type="button" class="btn btn-info">INFO</button>
                                    <button type="button" class="btn btn-success">SUCCESS</button>
                                    <button type="button" class="btn btn-warning">WARNING</button>
                                    <button type="button" class="btn btn-awesome">AWESOME</button>
                                    <button type="button" class="btn btn-disabled">DISABLED</button>
                                    <button type="button" class="btn btn-reload">RELOAD</button>
                                    <button type="button" class="btn btn-stories">STORIES</button>
                                    <button type="button" class="btn btn-primary border-radius-4">PRIMARY</button>
                                    <button type="button" class="btn btn-secondary border-radius-4">SECONDARY</button>
                                    <button type="button" class="btn btn-info border-radius-4">INFO</button>
                                    <button type="button" class="btn btn-success border-radius-4">SUCCESS</button>
                                    <button type="button" class="btn btn-warning border-radius-4">WARNING</button>
                                    <button type="button" class="btn btn-awesome border-radius-4">AWESOME</button>
                                    <button type="button" class="btn btn-disabled border-radius-4">DISABLED</button>
                                    <button type="button" class="btn btn-reload border-radius-4">RELOAD</button>
                                    <button type="button" class="btn btn-stories border-radius-4">STORIES</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="card ui-button-area ui-border-btn">
                                <div class="card-body">
                                    <h3 class="text-body text-22 text-bold mg-b-30">Border Button</h3>
                                    <button type="button" class="btn btn-outline-primary">PRIMARY</button>
                                    <button type="button" class="btn btn-outline-secondary">SECONDARY</button>
                                    <button type="button" class="btn btn-outline-info">INFO</button>
                                    <button type="button" class="btn btn-outline-success">SUCCESS</button>
                                    <button type="button" class="btn btn-outline-warning">WARNING</button>
                                    <button type="button" class="btn btn-outline-awesome">AWESOME</button>
                                    <button type="button" class="btn btn-outline-disabled">DISABLED</button>
                                    <button type="button" class="btn btn-outline-reload">RELOAD</button>
                                    <button type="button" class="btn btn-outline-stories">STORIES</button>
                                    <button type="button" class="btn btn-outline-primary border-radius-4">PRIMARY</button>
                                    <button type="button" class="btn btn-outline-secondary border-radius-4">SECONDARY</button>
                                    <button type="button" class="btn btn-outline-info border-radius-4">INFO</button>
                                    <button type="button" class="btn btn-outline-success border-radius-4">SUCCESS</button>
                                    <button type="button" class="btn btn-outline-warning border-radius-4">WARNING</button>
                                    <button type="button" class="btn btn-outline-awesome border-radius-4">AWESOME</button>
                                    <button type="button" class="btn btn-outline-disabled border-radius-4">DISABLED</button>
                                    <button type="button" class="btn btn-outline-reload border-radius-4">RELOAD</button>
                                    <button type="button" class="btn btn-outline-stories border-radius-4">STORIES</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="card ui-button-area ui-shadow-btn">
                                <div class="card-body">
                                    <h3 class="text-body text-22 text-bold mg-b-30">Shadow Button</h3>
                                    <button type="button" class="btn btn-primary">PRIMARY</button>
                                    <button type="button" class="btn btn-secondary">SECONDARY</button>
                                    <button type="button" class="btn btn-info">INFO</button>
                                    <button type="button" class="btn btn-success">SUCCESS</button>
                        ...
                        <div class="col-xl-6">
                            <div class="card ui-button-area">
                                <div class="card-body">
                                    <h3 class="text-body text-22 text-bold mg-b-30">Gradient Button</h3>
                                    ...
                                    <button type="button" class="btn btn-gradient-awesome">AWESOME</button>
                                    <button type="button" class="btn btn-gradient-disabled">DISABLED</button>
                                    <button type="button" class="btn btn-gradient-reload">RELOAD</button>
                                    <button type="button" class="btn btn-gradient-stories">STORIES</button>
                                    <button type="button" class="btn btn-gradient-primary border-radius-4">PRIMARY</button>
                                    <button type="button" class="btn btn-gradient-secondary border-radius-4">SECONDARY</button>
                                    <button type="button" class="btn btn-gradient-info border-radius-4">INFO</button>
                                    <button type="button" class="btn btn-gradient-success border-radius-4">SUCCESS</button>
                                    <button type="button" class="btn btn-gradient-warning border-radius-4">WARNING</button>
                                    <button type="button" class="btn btn-gradient-awesome border-radius-4">AWESOME</button>
                                    <button type="button" class="btn btn-gradient-disabled border-radius-4">DISABLED</button>
                                    <button type="button" class="btn btn-gradient-reload border-radius-4">RELOAD</button>
                                    <button type="button" class="btn btn-gradient-stories border-radius-4">STORIES</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="card ui-button-area ui-icon-btn">
                                <div class="card-body">
                                    <h3 class="text-body text-22 text-bold mg-b-30">Icon Button</h3>
                                    <button type="button" class="btn btn-primary">PRIMARY <i class="fas fa-angle-down"></i></button>
                                    <button type="button" class="btn btn-secondary">SECONDARY <i class="fas fa-caret-up"></i></button>
                                    <button type="button" class="btn btn-info">INFO <i class="fas fa-info"></i></button>
                                    <button type="button" class="btn btn-success">SUCCESS <i class="fas fa-check"></i></button>
                                    <button type="button" class="btn btn-warning">WARNING <i class="fas fa-running"></i></button>
                                    <button type="button" class="btn btn-awesome">AWESOME <i class="fas fa-download"></i></button>
                                    <button type="button" class="btn btn-disabled">DISABLED <i class="fas fa-wrench"></i></button>
                                    <button type="button" class="btn btn-reload">RELOAD <i class="fas fa-redo-alt"></i></button>
                                    <button type="button" class="btn btn-stories">STORIES <i class="fas fa-link"></i></button>
                                    <button type="button" class="btn btn-primary border-radius-4">PRIMARY <i class="fas fa-angle-down"></i></button>
                                    <button type="button" class="btn btn-secondary border-radius-4">SECONDARY <i class="fas fa-caret-up"></i></button>
                                    <button type="button" class="btn btn-info border-radius-4">INFO <i class="fas fa-info"></i></button>
                                    <button type="button" class="btn btn-success border-radius-4">SUCCESS <i class="fas fa-check"></i></button>
                                    <button type="button" class="btn btn-warning border-radius-4">WARNING <i class="fas fa-running"></i></button>
                                    <button type="button" class="btn btn-awesome border-radius-4">AWESOME <i class="fas fa-download"></i></button>
                                    <button type="button" class="btn btn-disabled border-radius-4">DISABLED <i class="fas fa-wrench"></i></button>
                                    <button type="button" class="btn btn-reload border-radius-4">RELOAD <i class="fas fa-redo-alt"></i></button>
                                    <button type="button" class="btn btn-stories border-radius-4">STORIES <i class="fas fa-link"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="card ui-button-area ui-icon-btn">
                                <div class="card-body">
                                    <h3 class="text-body text-22 text-bold mg-b-30">Icon Line Button</h3>
                                    <button type="button" class="btn btn-outline-primary">PRIMARY <i class="fas fa-angle-down"></i></button>
                                    <button type="button" class="btn btn-outline-secondary">SECONDARY <i class="fas fa-caret-up"></i></button>
                                    <button type="button" class="btn btn-outline-info">INFO <i class="fas fa-info"></i></button>
                                    <button type="button" class="btn btn-outline-success">SUCCESS <i class="fas fa-check"></i></button>
                                    <button type="button" class="btn btn-outline-warning">WARNING <i class="fas fa-running"></i></button>
                                    <button type="button" class="btn btn-outline-awesome">AWESOME <i class="fas fa-download"></i></button>
                                    <button type="button" class="btn btn-outline-disabled">DISABLED <i class="fas fa-wrench"></i></button>
                                    <button type="button" class="btn btn-outline-reload">RELOAD <i class="fas fa-redo-alt"></i></button>
                                    <button type="button" class="btn btn-outline-stories">STORIES <i class="fas fa-link"></i></button>
                                    <button type="button" class="btn btn-outline-primary border-radius-4">PRIMARY <i class="fas fa-angle-down"></i></button>
                                    <button type="button" class="btn btn-outline-secondary border-radius-4">SECONDARY <i class="fas fa-caret-up"></i></button>
                                    <button type="button" class="btn btn-outline-info border-radius-4">INFO <i class="fas fa-info"></i></button>
                                    <button type="button" class="btn btn-outline-success border-radius-4">SUCCESS <i class="fas fa-check"></i></button>
                                    <button type="button" class="btn btn-outline-warning border-radius-4">WARNING <i class="fas fa-running"></i></button>
                                    <button type="button" class="btn btn-outline-awesome border-radius-4">AWESOME <i class="fas fa-download"></i></button>
                                    <button type="button" class="btn btn-outline-disabled border-radius-4">DISABLED <i class="fas fa-wrench"></i></button>
                                    <button type="button" class="btn btn-outline-reload border-radius-4">RELOAD <i class="fas fa-redo-alt"></i></button>
                                    <button type="button" class="btn btn-outline-stories border-radius-4">STORIES <i class="fas fa-link"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
