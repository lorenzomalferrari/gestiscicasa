                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card map-area">
                                <div class="card-body">
                                    <h3 class="text-midnight text-bold text-22 mb-lg-5 mb-4">Basic Gmaps</h3>
                                    <div id="gmap-basic" class="google-map"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card map-area">
                                <div class="card-body">
                                    <h3 class="text-midnight text-bold text-22 mb-lg-5 mb-4">Gmaps Context Menu</h3>
                                    <div id="gmap-context" class="google-map"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card map-area">
                                <div class="card-body">
                                    <h3 class="text-midnight text-bold text-22 mb-lg-5 mb-4">Gmaps Marker</h3>
                                    <div id="gmap-marker" class="google-map"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card map-area">
                                <div class="card-body">
                                    <h3 class="text-midnight text-bold text-22 mb-lg-5 mb-4">Gmaps Custom Control</h3>
                                    <div id="gmap-control" class="google-map"></div>
                                </div>
                            </div>
                        </div>
                    </div>
