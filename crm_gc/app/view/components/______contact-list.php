...
<head>
    ...
    <title>Dashy | Contact List</title>
                        ...
                        <div class="contact-list">
                            <div class="table-responsive">
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img src="media/figure/img_33.jpg" alt="img"></td>
                                            <td>
                                                <h5 class="contact-name">Katja Simenson</h5>
                                                <div class="contact-designation">UI/UX Designer</div>
                                            </td>
                                            <td>Simenson@dashy.com</td>
                                            <td><a href="#">Photoshop,</a> <a href="#">illustrator,</a> <a href="#">Indesign</a></td>
                                            <td>175</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><img src="media/figure/img_34.jpg" alt="img"></td>
                                            <td>
                                                <h5 class="contact-name">John Balmer</h5>
                                                <div class="contact-designation">Senior Interior</div>
                                            </td>
                                            <td>Balmer@dashy.com</td>
                                            <td><a href="#">Photoshop,</a> <a href="#">illustrator,</a> <a href="#">Indesign</a></td>
                                            <td>142</td>
                                            <td>
                                                <a href="#"><i class="far fa-user-circle"></i></a>
                                        ...
                                        <tr>
                                            <td><img src="media/figure/img_35.jpg" alt="img"></td>
                                            <td>
                                                <h5 class="contact-name">Marry Scott</h5>
                                                <div class="contact-designation">Planning Manager</div>
                                            </td>
                                            <td>Scott@dashy.com</td>
                                        ...
                                        <tr>
                                            <td><img src="media/figure/img_36.jpg" alt="img"></td>
                                            <td>
                                                <h5 class="contact-name">Joseph Smith</h5>
                                        ...
                                        <tr>
                                            <td><img src="media/figure/img_37.jpg" alt="img"></td>
                                            <td>
                                                <h5 class="contact-name">Steve Cook</h5>
                                                <div class="contact-designation">Developer</div>
                                            </td>
                                            <td>Cook@dashy.com</td>
                                            <td><a href="#">illustrator, </a> <a href="#">Indesign</a></td>
                                            <td>116</td>
                                            <td>
                                                <a href="#"><i class="far fa-user-circle"></i></a>
                                                <a href="#"><i class="far fa-comments"></i></a>
                                        ...
                                        <tr>
                                            <td><img src="media/figure/img_38.jpg" alt="img"></td>
                                            <td>
                                                <h5 class="contact-name">Paula James</h5>
                                                <div class="contact-designation">Architecture Head</div>
                                            </td>
                                            <td>James@dashy.com</td>
                                            <td><a href="#">Photoshop,</a> <a href="#">illustrator, </a> <a href="#">Indesign</a></td>
                                            <td>96</td>
                                            <td>
                                                <a href="#"><i class="far fa-user-circle"></i></a>
                                        ...
                                        <tr>
                                            <td><img src="media/figure/img_39.jpg" alt="img"></td>
                                            <td>
                                                <h5 class="contact-name">Gina Bruno</h5>
                                                <div class="contact-designation">WEB Developer</div>
                                            </td>
                                            <td>Bruno@dashy.com</td>
                                            <td><a href="#">Photoshop,</a> <a href="#">Indesign</a></td>
                                            <td>105</td>
                                            <td>
                                                <a href="#"><i class="far fa-user-circle"></i></a>
                                                <a href="#"><i class="far fa-comments"></i></a>
                                        ...
                                        <tr>
                                            <td><img src="media/figure/img_40.jpg" alt="img"></td>
                                            <td>
                                                <h5 class="contact-name">David Ferry</h5>
                                                <div class="contact-designation">WEB Designer</div>
                                            </td>
                                            <td>Ferry@dashy.com</td>
                                            <td><a href="#">Photoshop,</a> <a href="#">illustrator,</a> <a href="#">Indesign</a></td>
                                            <td>86</td>
                                            <td>
                                                <a href="#"><i class="far fa-user-circle"></i></a>
