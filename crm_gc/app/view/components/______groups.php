                            ...
                            <div class="discover-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xxl-4">
                                        <div class="group-box">
                                            <div class="item-img">
                                                <img src="media/figure/group_1.jpg" alt="Group">
                                            </div>
                                            <div class="item-content">
                                                <div class="item-logo">
                                                    <img src="media/figure/group_p_1.jpg" alt="Logo">
                                                </div>
                                                <h5 class="item-title">Human Resources</h5>
                                                <div class="item-member">2,515,485 Members</div>
                                                <div class="btn-area">
                                                    <div class="member-count">
                                                        <a href="#">
                                                            <img src="media/figure/member_1.png" alt="Members">
                                                        </a>
                                                    </div>
                                                    <div class="join-btn">
                                                        <a href="#" class="item-btn">Join Now</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        <div class="group-box">
                                            <div class="item-img">
                                                <img src="media/figure/group_2.jpg" alt="Group">
                                            </div>
                                            <div class="item-content">
                                                <div class="item-logo">
                                                    <img src="media/figure/group_p_2.png" alt="Logo">
                                                </div>
                                                <h5 class="item-title">Dribbble Meetup</h5>
                                                <div class="item-member">515,485 Members</div>
                                                <div class="btn-area">
                                                    <div class="member-count">
                                                        <a href="#">
                                                            <img src="media/figure/member_2.png" alt="Members">
                                                        </a>
                                                    </div>
                                                    <div class="join-btn">
                                                        <a href="#" class="item-btn">Join Now</a>
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        <div class="group-box">
                                            <div class="item-img">
                                                <img src="media/figure/group_3.jpg" alt="Group">
                                            </div>
                                            <div class="item-content">
                                                <div class="item-logo">
                                                    <img src="media/figure/group_p_2.jpg" alt="Logo">
                                                </div>
                                                <h5 class="item-title">Behance Meetup 2020</h5>
                                                <div class="item-member">415,485 Members</div>
                                                <div class="btn-area">
                                                    <div class="member-count">
                                                        <a href="#">
                                                            <img src="media/figure/member_3.png" alt="Members">
                                                        </a>
                                                    </div>
                                                    <div class="join-btn">
                                                        <a href="#" class="item-btn">Join Now</a>
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        <div class="group-box">
                                            <div class="item-img">
                                                <img src="media/figure/group_4.jpg" alt="Group">
                                            </div>
                                            <div class="item-content">
                                                <div class="item-logo">
                                                    <img src="media/figure/group_p_3.jpg" alt="Logo">
                                                </div>
                                                <h5 class="item-title">Envato Groups</h5>
                                                <div class="item-member">315,485 Members</div>
                                                <div class="btn-area">
                                                    <div class="member-count">
                                                        <a href="#">
                                                            <img src="media/figure/member_3.png" alt="Members">
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        <div class="group-box">
                                            <div class="item-img">
                                                <img src="media/figure/group_5.jpg" alt="Group">
                                            </div>
                                            <div class="item-content">
                                                <div class="item-logo">
                                                    <img src="media/figure/group_p_4.jpg" alt="Logo">
                                                </div>
                                                <h5 class="item-title">Wordpress Groups</h5>
                                                <div class="item-member">215,485 Members</div>
                                                <div class="btn-area">
                                                    <div class="member-count">
                                                        <a href="#">
                                                            <img src="media/figure/member_4.png" alt="Members">
                                                        </a>
                                                    </div>
                                                    <div class="join-btn">
                                                        <a href="#" class="item-btn">Join Now</a>
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        <div class="group-box">
                                            <div class="item-img">
                                                <img src="media/figure/group_6.jpg" alt="Group">
                                            </div>
                                            <div class="item-content">
                                                <div class="item-logo">
                                                    <img src="media/figure/group_p_5.jpg" alt="Logo">
                                                </div>
                                                <h5 class="item-title">Developers Meetup 2020</h5>
                                                <div class="item-member">15,485 Members</div>
                                                <div class="btn-area">
                                                    <div class="member-count">
                                                        <a href="#">
                                                            <img src="media/figure/member_5.png" alt="Members">
                                                        </a>
                                                    </div>
                                                    <div class="join-btn">
                                                        <a href="#" class="item-btn">Join Now</a>
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        <div class="group-box">
                                            <div class="item-img">
                                                <img src="media/figure/group_7.jpg" alt="Group">
                                            </div>
                                            <div class="item-content">
                                                <div class="item-logo">
                                                    <img src="media/figure/group_p_6.jpg" alt="Logo">
                                                </div>
                                                <h5 class="item-title">Front end Developer</h5>
                                                <div class="item-member">615,485 Members</div>
                                                <div class="btn-area">
                                                    <div class="member-count">
                                                        <a href="#">
                                                            <img src="media/figure/member_2.png" alt="Members">
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        <div class="group-box">
                                            <div class="item-img">
                                                <img src="media/figure/group_8.jpg" alt="Group">
                                            </div>
                                            <div class="item-content">
                                                <div class="item-logo">
                                                    <img src="media/figure/group_p_7.jpg" alt="Logo">
                                                </div>
                                                <h5 class="item-title">Android Developer</h5>
                                                <div class="item-member">15,485 Members</div>
                                                <div class="btn-area">
                                                    <div class="member-count">
                                                        <a href="#">
                            ...
                            <div class="connection-widget">
                                <div class="widget">
                                    <div class="widget-people">
                                        <h6 class="text-body text-bold mb-4">POPULAR GROUPS</h6>
                                        <div class="people-list">
                                            <a href="#" class="media">
                                                <div class="item-img">
                                                    <img src="media/figure/img_27.jpg" alt="Thumb">
                                                </div>
                                                <div class="media-body">
                                                    <h5 class="item-title text-bold mb-0">Developers Meetup</h5>
                                                    <div class="text-bombay">15,485 Members</div>
                                                </div>
                                            </a>
                                            <a href="#" class="media">
                                                <div class="item-img">
                                                    <img src="media/figure/img_28.jpg" alt="Thumb">
                                                </div>
                                                <div class="media-body">
                                                    <h5 class="item-title text-bold mb-0">Human Resources</h5>
                                                    <div class="text-bombay">2,515,485 Members</div>
                                                </div>
                                            </a>
                                            <a href="#" class="media">
                                                <div class="item-img">
                                                    <img src="media/figure/img_29.jpg" alt="Thumb">
                                                </div>
                                                <div class="media-body">
                                                    <h5 class="item-title text-bold mb-0">Front end Developer</h5>
                                                    <div class="text-bombay">615,485 Members</div>
                                                </div>
                                            </a>
                                            <a href="#" class="media">
                                                <div class="item-img">
                                                    <img src="media/figure/img_30.jpg" alt="Thumb">
                                                </div>
                                                <div class="media-body">
                                                    <h5 class="item-title text-bold mb-0">Android Developer</h5>
                                                    <div class="text-bombay">15,485 Members</div>
                                                </div>
                                            </a>
                                            <a href="#" class="media">
                                                <div class="item-img">
                                                    <img src="media/figure/img_31.jpg" alt="Thumb">
                                                </div>
                                                <div class="media-body">
                                                    <h5 class="item-title text-bold mb-0">UI Designers World</h5>
                                                    <div class="text-bombay">1,055,767 Members</div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="widget">
                                    <div class="widget-discover">
                                        <h6 class="text-body text-bold mb-3">DISCOVER BY POSITION</h6>
                                        <ul class="discover-list">
                                            <li>
                                                <a href="#">Software Engineer <span>20</span> </a>
                                            </li>
                                            <li>
                                                <a href="#">UI/UX Designer<span>18</span> </a>
                                            </li>
                                            <li>
                                                <a href="#">Sales Representative<span>14</span> </a>
                                            </li>
                                            <li>
                                                <a href="#">Product Representative<span>12</span> </a>
                                            </li>
                                            <li>
                                                <a href="#">Full-Stack Developer<span>10</span> </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="widget">
                                    <div class="widget-discover">
                                        <h6 class="text-body text-bold mb-3">DISCOVER BY LOCATION</h6>
                                        <ul class="discover-list">
                                            <li>
                                                <a href="#">San Francisco, California<span>20</span> </a>
                                            </li>
                                            <li>
                                                <a href="#">Los Angeles, California<span>18</span> </a>
                                            </li>
                                            <li>
                                                <a href="#">Las Vegas, Nevada<span>14</span> </a>
                                            </li>
                                            <li>
                                                <a href="#">Austin, Texas<span>12</span> </a>
                                            </li>
                                            <li>
                                                <a href="#">Arlington, Nebraska<span>10</span> </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
