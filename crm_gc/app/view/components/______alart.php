        ...
        <div class="dsy-page">
            ...
            <div class="dsy-page-content vertical-menu">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card ui-alart">
                                <div class="card-body">
                                    <h3 class="text-22 text-midnight text-bold mb-4">Default Alert</h3>
                                    <div class="alert alert-primary text-midnight" role="alert">
                                        A simple primary alert—check it out!
                                    </div>
                                    <div class="alert alert-secondary text-midnight" role="alert">
                                        A simple secondary alert—check it out!
                                    </div>
                                    <div class="alert alert-success text-midnight" role="alert">
                                        A simple success alert—check it out!
                                    </div>
                                    <div class="alert alert-danger text-midnight" role="alert">
                                        A simple danger alert—check it out!
                                    </div>
                                    <div class="alert alert-warning text-midnight" role="alert">
                                        A simple warning alert—check it out!
                                    </div>
                                    <div class="alert alert-info text-midnight mb-0" role="alert">
                        ...
                        <div class="col-xl-6">
                            <div class="card ui-alart">
                                <div class="card-body">
                                    <h3 class="text-22 text-midnight text-bold mb-4">Alert With Icon</h3>
                                    <div class="alert alert-primary text-midnight alert-dismissible fade show" role="alert">
                                        <span class="left-icon"><i class="far fa-bell-slash"></i></span>
                                        A simple primary alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true" class="fas fa-times-circle"></span>
                                        </button>
                                    </div>
                                    <div class="alert alert-secondary text-midnight alert-dismissible fade show" role="alert">
                                        <span class="left-icon"><i class="fas fa-check"></i></span>
                                        A simple secondary alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true" class="fas fa-times-circle"></span>
                                        </button>
                                    </div>
                                    <div class="alert alert-success text-midnight alert-dismissible fade show" role="alert">
                                    ...
                                    <div class="alert alert-danger text-midnight alert-dismissible fade show" role="alert">
                                        <span class="left-icon"><i class="far fa-check-circle"></i></span>
                                        A simple danger alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true" class="fas fa-times-circle"></span>
                                        </button>
                                    </div>
                                    <div class="alert alert-warning text-midnight alert-dismissible fade show" role="alert">
                                        <span class="left-icon"><i class="far fa-check-square"></i></span>
                                        A simple warning alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true" class="fas fa-times-circle"></span>
                                        </button>
                                    </div>
                                    <div class="alert alert-info text-midnight mb-0 alert-dismissible fade show" role="alert">
                                        <span class="left-icon"><i class="fas fa-info"></i></span>
                                        A simple info alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true" class="fas fa-times-circle"></span>
                                        </button>
                        ...
                        <div class="col-xl-6">
                            <div class="card ui-alart alart-icon">
                                <div class="card-body">
                                    <h3 class="text-22 text-midnight text-bold mb-4">Dismissing Alert</h3>
                                    <div class="alert alert-primary text-midnight alert-dismissible fade show" role="alert">
                                        A simple primary alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true" class="fas fa-times-circle"></span>
                        ...
                        <div class="col-xl-6">
                            <div class="card ui-alart">
                                <div class="card-body">
                                    <h3 class="text-22 text-midnight text-bold mb-4">Colored Alerts With Icons</h3>
                                    <div class="alert bg-corn-blue text-white alert-dismissible fade show" role="alert">
                                        <span class="left-icon"><i class="far fa-bell-slash"></i></span>
                                        A simple primary alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    ...
                                    <div class="alert bg-silver text-white alert-dismissible fade show" role="alert">
                                        <span class="left-icon"><i class="fas fa-check"></i></span>
                                        A simple secondary alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true" class="fas fa-times-circle text-white"></span>
                                    ...
                                    <div class="alert bg-bermuda text-white alert-dismissible fade show" role="alert">
                                        <span class="left-icon"><i class="fas fa-check-double"></i></span>
                                        A simple success alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true" class="fas fa-times-circle text-white"></span>
                                    ...
                                    <div class="alert bg-froly text-white alert-dismissible fade show" role="alert">
                                        <span class="left-icon"><i class="far fa-check-circle"></i></span>
                                        A simple danger alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true" class="fas fa-times-circle text-white"></span>
                                    ...
                                    <div class="alert bg-porsche text-white alert-dismissible fade show" role="alert">
                                        <span class="left-icon"><i class="far fa-check-square"></i></span>
                                        A simple warning alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true" class="fas fa-times-circle text-white"></span>
                                    ...
                                    <div class="alert bg-portage text-white mb-0 alert-dismissible fade show" role="alert">
                                        <span class="left-icon"><i class="fas fa-info"></i></span>
                                        A simple info alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
