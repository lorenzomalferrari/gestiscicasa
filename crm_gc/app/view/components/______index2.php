...
<head>
    ...
    <title>Dashy | Website Analytics</title>
    ...
    <div id="main-wrapper" class="dsy-main-wrapper">
        <div class="dsy-page">
            ...
            <div class="dsy-page-content vertical-menu">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-7">
                                <div class="breadcrumbs-btn">
                                    <ul>
                                        <li><a href="#"><i class="flaticon-floppy-disk"></i>SAVE</a></li>
                                        <li><a href="#"><i class="flaticon-export"></i>EXPORT</a></li>
                                        <li><a href="#"><i class="flaticon-levels"></i>SETTINGS</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <!--=        	Chart Area Start     	=-->
                <!--=====================================-->
                <div class="website-chart-area">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xxl-8">
                                <div class="card web-chart web-audience">
                                    <div class="card-body">
                                        <div class="row align-items-center mb-4">
                                            <div class="col-md-4">
                                                <h3 class="section-title mb-1">Audience Overview</h3>
                                                <div class="text-regent-gray text-13">01/17/20 - 01/29/2020</div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="duration-btn text-md-right">
                                                    <a href="#">Today</a>
                                                    <a href="#">7d</a>
                                                    <a href="#" class="active">2w</a>
                                                    <a href="#">1m</a>
                                                    <a href="#">3m</a>
                                                    <a href="#">2020</a>
                                                </div>
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                <div class="audience-list">
                                                    <div class="row no-gutters">
                                                        <div class="col-6">
                                                            <h6 class="item-title">New Users</h6>
                                                            <h6 class="new-number">19,202</h6>
                                                        </div>
                                                        <div class="col-6 text-right">
                                                            <div class="item-ratio text-mountain-meadow"><i class="flaticon-null-22"></i>12.37%</div>
                                                            <h6 class="old-number">17,500</h6>
                                                        </div>
                                                    </div>
                                                    <div class="progress">
                                                        <div class="progress-bar" role="progressbar" style="width: 70%; background-color: #80e6e6;" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-sm-6">
                                                <div class="audience-list">
                                                    <div class="row no-gutters">
                                                        <div class="col-6">
                                                            <h6 class="item-title">Page Views</h6>
                                                            <h6 class="new-number">94,456</h6>
                                                        </div>
                                                        <div class="col-6 text-right">
                                                            <div class="item-ratio text-mountain-meadow"><i class="flaticon-null-22"></i>08.60%</div>
                                                            <h6 class="old-number">1,45,024</h6>
                                                        </div>
                                                    </div>
                                                    <div class="progress">
                                                        <div class="progress-bar" role="progressbar" style="width: 60%; background-color: #febf8a;" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-sm-6">
                                                <div class="audience-list">
                                                    <div class="row no-gutters">
                                                        <div class="col-lg-8 col-6">
                                                            <h6 class="item-title">Page Sessions</h6>
                                                            <h6 class="new-number">15,245</h6>
                                                        </div>
                                                        <div class="col-lg-4 col-6 text-right">
                                                            <div class="item-ratio text-light-red"><i class="flaticon-null-25"></i>12.37%</div>
                                                            <h6 class="old-number">75,250</h6>
                                                        </div>
                                                    </div>
                                                    <div class="progress">
                                                        <div class="progress-bar" role="progressbar" style="width: 40%; background-color: #f880ba;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-sm-6">
                                                <div class="audience-list">
                                                    <div class="row no-gutters">
                                                        <div class="col-lg-8 col-6">
                                                            <h6 class="item-title">Bounce Rate</h6>
                                                            <h6 class="new-number">25.35%</h6>
                                                        </div>
                                                        <div class="col-lg-4 col-6 text-right">
                                                            <div class="item-ratio text-mountain-meadow"><i class="flaticon-null-22"></i>05.23%</div>
                                                            <h6 class="old-number">45.75%</h6>
                                                        </div>
                                                    </div>
                                                    <div class="progress">
                                                        <div class="progress-bar" role="progressbar" style="width: 75%; background-color: #80b4fc;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="audience-chart">
                                            <canvas id="audience-chart" width="100" height="250"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-4">
                                <div class="card web-chart web-traffic">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-7">
                                                <h3 class="section-title">Traffic Channel</h3>
                                            </div>
                                            <div class="col-5">
                                        ...
                                        <div class="doughnut-chart">
                                            <canvas id="doughnut-chart" width="100" height="215"></canvas>
                                        </div>
                                        <div class="traffic-list">
                                            <div class="row gutters-10">
                                                <div class="col-xxl-6 col-md-3 col-sm-6">
                                                    <div class="media">
                                                        <div class="item-bar bg-dodger-blue"></div>
                                                        <div class="media-body">
                                                            <h6 class="item-title">Organic Search</h6>
                                                            <h6 class="item-number">2,541 <span class="text-12 text-regent-gray text-regular">(43.95%)</span></h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-3 col-sm-6">
                                                    <div class="media">
                                                        <div class="item-bar bg-hot-pink"></div>
                                                        <div class="media-body">
                                                            <h6 class="item-title">Social Media</h6>
                                                            <h6 class="item-number">1,935 <span class="text-12 text-regent-gray text-regular">(23.68%)</span></h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-3 col-sm-6">
                                                    <div class="media">
                                                        <div class="item-bar bg-cyan"></div>
                                                        <div class="media-body">
                                                            <h6 class="item-title">Referrals</h6>
                                                            <h6 class="item-number">1,320 <span class="text-12 text-regent-gray text-regular">(11.22%)</span></h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-3 col-sm-6">
                                                    <div class="media">
                                                        <div class="item-bar bg-tagerine"></div>
                                                        <div class="media-body">
                                                            <h6 class="item-title">Email</h6>
                                                            <h6 class="item-number">1,579 <span class="text-12 text-regent-gray text-regular">(21.15%)</span></h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-xxl-4 col-lg-6">
                                <div class="card web-chart web-perform">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-8">
                                        ...
                                        <div class="perform-box">
                                            <h4 class="item-title">Bounce Rate (avg)</h4>
                                            <div class="row align-items-center">
                                                <div class="col-7">
                                                    <div class="perform-chart">
                                                        <canvas id="perform-chart1" width="100" height="40"></canvas>
                                                    </div>
                                                </div>
                                                <div class="col-5">
                                                    <h4 class="item-ratio">24.67%</h4>
                                                    <div class="item-growth text-mountain-meadow"><i class="flaticon-null-22"></i>04.18%</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="perform-box">
                                            <h4 class="item-title">Pageviews (avg)</h4>
                                            <div class="row align-items-center">
                                                <div class="col-7">
                                                    <div class="perform-chart">
                                                        <canvas id="perform-chart2" width="100" height="40"></canvas>
                                                    </div>
                                                </div>
                                                <div class="col-5">
                                                    <h4 class="item-ratio">6.94%</h4>
                                                    <div class="item-growth text-light-red"><i class="flaticon-null-25"></i>01.57%</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="perform-box mb-0">
                                            <h4 class="item-title">Time on Site (avg)</h4>
                                            <div class="row align-items-center">
                                                <div class="col-7">
                                                    <div class="perform-chart">
                                                        <canvas id="perform-chart3" width="100" height="40"></canvas>
                                                    </div>
                                                </div>
                                                <div class="col-5">
                                                    <h4 class="item-ratio">2m 56s</h4>
                                                    <div class="item-growth text-mountain-meadow"><i class="flaticon-null-22"></i>01.48%</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xxl-4 col-lg-6">
                                <div class="card web-chart web-users">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-6">
                                        ...
                                        <div class="user-duration">
                                            <div class="row gutters-15">
                                                <div class="col-4">
                                                    <div class="user-time">
                                                        <h6 class="item-title">Monthly</h6>
                                                        <h5 class="item-amount">8.95K</h5>
                                                        <div class="item-ratio text-mountain-meadow"><i class="flaticon-null-22"></i>05.06%</div>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="user-time">
                                                        <h6 class="item-title">Weekly</h6>
                                                        <h5 class="item-amount">4.37K</h5>
                                                        <div class="item-ratio text-light-red"><i class="flaticon-null-25"></i>00.77%</div>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="user-time">
                                                        <h6 class="item-title">Today</h6>
                                                        <h5 class="item-amount">9.38K</h5>
                                                        <div class="item-ratio text-mountain-meadow"><i class="flaticon-null-22"></i>00.23%</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="user-chart">
                                            <canvas id="users-chart" width="100" height="200"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-4 col-lg-6">
                                <div class="card web-chart web-session">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-7">
                                                <h3 class="section-title">Device Sessions</h3>
                                            </div>
                                            <div class="col-5">
                                                <div class="dropdown section-dropdown">
                                                    <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-expanded="false">30 Days<i class="flaticon-null-16"></i></a>
                                        ...
                                        <div class="device-type">
                                            <div class="row gutters-10">
                                                <div class="col-sm-4">
                                                    <div class="media">
                                                        <div class="item-icon text-blue-ribbon">
                                                            <i class="flaticon-mobile"></i>
                                                        </div>
                                                        <div class="media-body">
                                                            <h6 class="item-title">Mobile</h6>
                                                            <h6 class="item-number">7,548</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="media">
                                                        <div class="item-icon text-yellow">
                                                            <i class="flaticon-desktop"></i>
                                                        </div>
                                                        <div class="media-body">
                                                            <h6 class="item-title">Desktop</h6>
                                                            <h6 class="item-number">9,672</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="media">
                                                        <div class="item-icon text-brink-pink">
                                                            <i class="flaticon-tablet"></i>
                                                        </div>
                                                        <div class="media-body">
                                                            <h6 class="item-title">Tablet</h6>
                                                            <h6 class="item-number">5,548</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-xxl-4 col-lg-6">
                                <div class="card web-table visitor-table">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-8">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-borderless">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><a href="#" class="link-icon"><i class="flaticon-foreign"></i></a></td>
                                                        <td>
                                                            <h6 class="text-bold text-14 mb-0">Home Page</h6>
                                                        </td>
                                                        <td>
                                                            <div class="progress">
                                                                <div class="progress-bar" role="progressbar" style="width: 65%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><span>84.24%</span></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><a href="#" class="link-icon"><i class="flaticon-foreign"></i></a></td>
                                                        <td>
                                                            <h6 class="text-bold text-14 mb-0">Services Page</h6>
                                                        </td>
                                                        <td>
                                                            <div class="progress">
                                                                <div class="progress-bar" role="progressbar" style="width: 60%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><span>75.17%</span></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><a href="#" class="link-icon"><i class="flaticon-foreign"></i></a></td>
                                                        <td>
                                                            <h6 class="text-bold text-14 mb-0">List of Products</h6>
                                                        </td>
                                                        <td>
                                                            <div class="progress">
                                                                <div class="progress-bar" role="progressbar" style="width: 50%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><span>67.48%</span></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><a href="#" class="link-icon"><i class="flaticon-foreign"></i></a></td>
                                                        <td>
                                                            <h6 class="text-bold text-14 mb-0">Products Single</h6>
                                                        </td>
                                                        <td>
                                                            <div class="progress">
                                                                <div class="progress-bar" role="progressbar" style="width: 62%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><span>77.13%</span></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><a href="#" class="link-icon"><i class="flaticon-foreign"></i></a></td>
                                                        <td>
                                                            <h6 class="text-bold text-14 mb-0">About Us</h6>
                                                        </td>
                                                        <td>
                                                            <div class="progress">
                                                                <div class="progress-bar" role="progressbar" style="width: 52%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><span>68.95%</span></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><a href="#" class="link-icon"><i class="flaticon-foreign"></i></a></td>
                                                        <td>
                                                            <h6 class="text-bold text-14 mb-0">Contact Us</h6>
                                                        </td>
                                                        <td>
                                                            <div class="progress">
                                                                <div class="progress-bar" role="progressbar" style="width: 64%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><span>80.96%</span></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                            ...
                            <div class="col-xxl-8">
                                <div class="card web-table browser-table">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-8">
                                                <h3 class="section-title">Browser Used by Users</h3>
                                            </div>
                                            <div class="col-4">
                                                <div class="dropdown section-dropdown">
                                                    <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-expanded="false">30 Days<i class="flaticon-null-16"></i></a>
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="text-right">Conversion Rate</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td class="d-flex align-items-center"><img src="media/figure/chrome.png" alt="Chrome">
                                                            <h6 class="text-bold text-14 mb-0">Google Chrome</h6>
                                                        </td>
                                                        <td>15,758</td>
                                                        <td>40.95%</td>
                                                    ...
                                                    <tr>
                                                        <td class="d-flex align-items-center"><img src="media/figure/mozilla.png" alt="Chrome">
                                                            <h6 class="text-bold text-14 mb-0">Mozilla Firefox</h6>
                                                        </td>
                                                        <td>11,025</td>
                                                        <td>33.13%</td>
                                                    ...
                                                    <tr>
                                                        <td class="d-flex align-items-center"><img src="media/figure/safari.png" alt="Chrome">
                                                            <h6 class="text-bold text-14 mb-0">Apple Safari</h6>
                                                        </td>
                                                        <td>14,175</td>
                                                        <td>39.36%</td>
                                                    ...
                                                    <tr>
                                                        <td class="d-flex align-items-center"><img src="media/figure/edge.png" alt="Chrome">
                                                            <h6 class="text-bold text-14 mb-0">Microsoft Edge</h6>
                                                        </td>
                                                        <td>09,184</td>
                                                        <td>39.36%</td>
                                                        <td class="text-right">18.05%</td>
                                                    ...
                                                    <tr>
                                                        <td class="d-flex align-items-center"><img src="media/figure/opera.png" alt="Chrome">
                                                            <h6 class="text-bold text-14 mb-0">Opera Mini</h6>
                                                        </td>
                                                        <td>5,295</td>
                                                        <td>55.12%</td>
                                                        <td class="text-right">06.08%</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="d-flex align-items-center"><img src="media/figure/uc.png" alt="Chrome">
                                                            <h6 class="text-bold text-14 mb-0">UC Browser</h6>
                                                        </td>
                                                        <td>00,984</td>
                                                        <td>49.84%</td>
                                                        <td class="text-right">03.06%</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
