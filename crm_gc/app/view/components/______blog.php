                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-4 col-md-6 col-12">
                                <div class="blog-box">
                                    <div class="blog-img">
                                        <img src="media/figure/blog_1.jpg" alt="Thumb">
                                        <div class="blog-category bg-apple">Technologies</div>
                                    </div>
                                    <div class="blog-content">
                                        <h3 class="blog-title"><a href="#">3 Our Customers Success Tell about Their are Company’s Story</a></h3>
                                        <p>There are many variations of passages of Lorem the suffered humour or slightly believable. If you are as need anything embarrassing.</p>
                                        <ul class="entry-meta">
                                            <li><img src="media/figure/author_1.jpg" alt="Author">by <a href="#">Nikki Newman</a></li>
                                            <li><i class="far fa-calendar-alt"></i>12 jun, 2020</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-md-6 col-12">
                                <div class="blog-box">
                                    <div class="blog-img">
                                        <img src="media/figure/blog_2.jpg" alt="Thumb">
                                        <div class="blog-category bg-cerulean">Security</div>
                                    </div>
                                    <div class="blog-content">
                                        <h3 class="blog-title"><a href="#">Introduce New Feature: Real-Time Analytics and Reports</a></h3>
                                        <p>There are many variations of passages of Lorem the suffered humour or slightly believable. If you are as need anything embarrassing.</p>
                                        <ul class="entry-meta">
                                            <li><img src="media/figure/author_2.jpg" alt="Author">by <a href="#"> Jake Paul</a></li>
                                            <li><i class="far fa-calendar-alt"></i>15 jun, 2020</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-md-6 col-12">
                                <div class="blog-box">
                                    <div class="blog-img">
                                        <img src="media/figure/blog_3.jpg" alt="Thumb">
                                        <div class="blog-category bg-shoking-pink">Business</div>
                                    </div>
                                    <div class="blog-content">
                                        <h3 class="blog-title"><a href="#">Data Privacy and Security Features You Should Know</a></h3>
                                        <p>There are many variations of passages of Lorem the suffered humour or slightly believable. If you are as need anything embarrassing.</p>
                                        <ul class="entry-meta">
                                            <li><img src="media/figure/author_3.jpg" alt="Author">by <a href="#">Isabella Ava</a></li>
                                            <li><i class="far fa-calendar-alt"></i>19 jun, 2020</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-md-6 col-12">
                                <div class="blog-box">
                                    <div class="blog-img">
                                        <img src="media/figure/blog_4.jpg" alt="Thumb">
                                        <div class="blog-category bg-royal-blue">Education</div>
                                    </div>
                                    <div class="blog-content">
                                        <h3 class="blog-title"><a href="#">Introduce New Feature: Real-Time Analytics and Reports</a></h3>
                                        <p>There are many variations of passages of Lorem the suffered humour or slightly believable. If you are as need anything embarrassing.</p>
                                        <ul class="entry-meta">
                                            <li><img src="media/figure/author_4.jpg" alt="Author">by <a href="#">Danny Ings</a></li>
                                            <li><i class="far fa-calendar-alt"></i>21 jun, 2020</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-md-6 col-12">
                                <div class="blog-box">
                                    <div class="blog-img">
                                        <img src="media/figure/blog_5.jpg" alt="Thumb">
                                        <div class="blog-category bg-purple-heart">Fashion</div>
                                    </div>
                                    <div class="blog-content">
                                        <h3 class="blog-title"><a href="#">Data Privacy and Security Features You Should Know</a></h3>
                                        <p>There are many variations of passages of Lorem the suffered humour or slightly believable. If you are as need anything embarrassing.</p>
                                        <ul class="entry-meta">
                                            <li><img src="media/figure/author_5.jpg" alt="Author">by <a href="#">David Lee</a></li>
                                            <li><i class="far fa-calendar-alt"></i>22 jun, 2020</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-md-6 col-12">
                                <div class="blog-box">
                                    <div class="blog-img">
                                        <img src="media/figure/blog_6.jpg" alt="Thumb">
                                        <div class="blog-category bg-bright-turquoise">Travel</div>
                                    </div>
                                    <div class="blog-content">
                                        <h3 class="blog-title"><a href="#">What is GDPR, The Summary Guide to GDPR Features!</a></h3>
                                        <p>There are many variations of passages of Lorem the suffered humour or slightly believable. If you are as need anything embarrassing.</p>
                                        <ul class="entry-meta">
                                            <li><img src="media/figure/author_6.jpg" alt="Author">by <a href="#">Isabella Ava</a></li>
                                            <li><i class="far fa-calendar-alt"></i>27 jun, 2020</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
