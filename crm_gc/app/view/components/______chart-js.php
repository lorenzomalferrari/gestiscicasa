        ...
        <div class="dsy-page">
            ...
            <div class="dsy-page-content vertical-menu">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card chart-js">
                                <div class="card-body">
                                    <h3 class="color-body text-22 text-bold mb-md-5 mb-4">Bar Chart</h3>
                                    <div>
                                        <canvas id="bar-chart" width="100" height="250"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card chart-js">
                                <div class="card-body">
                                    <h3 class="color-body text-22 text-bold mb-md-5 mb-4">Horizontal Bar Chart</h3>
                                    <div>
                                        <canvas id="horizontal-chart" width="100" height="250"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card chart-js">
                                <div class="card-body">
                                    <h3 class="color-body text-22 text-bold mb-md-5 mb-4">Group Bar Chart</h3>
                                    <div>
                                        <canvas id="users-chart" width="100" height="250"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card chart-js">
                                <div class="card-body">
                                    <h3 class="color-body text-22 text-bold mb-md-5 mb-4">Pie Chart</h3>
                                    <div>
                                        <canvas id="pie-chart" width="100" height="250"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card chart-js">
                                <div class="card-body">
                                    <h3 class="color-body text-22 text-bold mb-md-5 mb-4">Area Background Chart</h3>
                                    <div>
                        ...
                        <div class="col-lg-6">
                            <div class="card chart-js">
                                <div class="card-body">
                                    <h3 class="color-body text-22 text-bold mb-md-5 mb-4">Area Background Chart</h3>
                                    <div>
                                        <canvas id="crypto-chart" width="100" height="250"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card chart-js">
                                <div class="card-body">
                                    <h3 class="color-body text-22 text-bold mb-md-5 mb-4">Area Chart</h3>
                                    <div>
                        ...
                        <div class="col-lg-6">
                            <div class="card chart-js">
                                <div class="card-body">
                                    <h3 class="color-body text-22 text-bold mb-md-5 mb-4">Doughnut Chart</h3>
                                    <div>
                                        <canvas id="doughnut-chart" width="100" height="250"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
