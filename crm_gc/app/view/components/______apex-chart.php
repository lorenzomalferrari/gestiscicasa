...
<head>
    ...
    <title>Dashy | Apex Chart Js</title>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card chart-js">
                                <div class="card-body">
                                    <h3 class="text-body text-bold text-22 mb-4">Basic Line</h3>
                                    <div id="summery-line1" class="mb-4"></div>
                                    <div id="summery-line2" class="mb-4"></div>
                                    <div id="summery-line3" class="mb-4"></div>
                        ...
                        <div class="col-lg-6">
                            <div class="card chart-js">
                                <div class="card-body">
                                    <h3 class="text-body text-bold text-22 mb-4">Stacked Area</h3>
                                    <div id="stacked-chart2"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card chart-js crypto-overview">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <h3 class="text-body text-bold text-22 mb-4">Date Time</h3>
                                        </div>
                                        <div class="col-lg-8">
                                            <div class="toolbar mt-1">
                                                <button id="all">Today</button>
                        ...
                        <div class="col-lg-6">
                            <div class="card chart-js">
                                <div class="card-body">
                                    <h3 class="text-body text-bold text-22 mb-4">Radial Chart</h3>
                        ...
                        <div class="col-lg-6">
                            <div class="card chart-js">
                                <div class="card-body">
                                    <h3 class="text-body text-bold text-22 mb-4">Line Area</h3>
                                    <div id="apex-line" class="apex-chart"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card chart-js">
                                <div class="card-body">
                                    <h3 class="text-body text-bold text-22 mb-4">Line with Data Labels</h3>
                                    <div id="apex-dataline" class="apex-chart"></div>
                                </div>
                            </div>
                        </div>
                    </div>
