                            ...
                            <div class="card email-table">
                                <div class="card-body">
                                        ...
                                        <table class="table table-borderless">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><span class="text-15"><i class="far fa-star"></i></span></td>
                                                    <td class="text-14">Anderson, me (5)</td>
                                                    <td>Trip home from arranged, then come get me from Stockholm. :)</td>
                                                    <td>Mar 8</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><span class="text-15"><i class="far fa-star"></i></span></td>
                                                    <td class="text-14">Web Support me (8)</td>
                                                    <td>Re: New mail settings – Will you answer him asap?</td>
                                                    <td>Mar 6</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><span class="text-15"><i class="far fa-star"></i></span></td>
                                                    <td class="text-14">Jimmy, me (16)</td>
                                                    <td><span class="badge bg-picton-blue text-white">Support</span> Eff that place, Sent from iPhone 4 4 mar 2014 at 5:55 pm</td>
                                                    <td>Mar 5</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><span class="text-15"><i class="far fa-star"></i></span></td>
                                                    <td class="text-14">Riyee, me (2)</td>
                                                    <td>To create this month's pack,Jared Mahone here in Columbus, Ohio</td>
                                                    <td>Mar 5</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><span class="text-15"><i class="far fa-star"></i></span></td>
                                                    <td class="text-14">Jensen, me (3)</td>
                                                    <td><span class="badge bg-cerise-red text-white">Personal</span> Today's Friday music you should give a listen!</td>
                                                    <td>Mar 3</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><span class="text-15"><i class="far fa-star"></i></span></td>
                                                    <td class="text-14">Jacob, me (1)</td>
                                                    <td>Hey, You wanna join me and Fred lake tomorrow? It'll be awesome.</td>
                                                    <td>Mar 3</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><span class="text-15"><i class="far fa-star"></i></span></td>
                                                    <td class="text-14">Mitchell, me (2)</td>
                                                    <td>That's great, see you on Thursday!</td>
                                                    <td>Mar 3</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><span class="text-15"><i class="far fa-star"></i></span></td>
                                                    <td class="text-14">Taylor, me (7)</td>
                                                    <td>Hey man – Nah man sorry i don't. Should i get it?</td>
                                                    <td>Mar 2</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><span class="text-15"><i class="far fa-star"></i></span></td>
                                                    <td class="text-14">Ronald, me (7)</td>
                                                    <td><span class="badge bg-mountain-meadow text-white">Family</span> Nah man sorry i don't. Should i get it?</td>
                                                    <td>Mar 3</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="text-15"><i class="far fa-star"></i></span></td>
                                                    <td class="text-14">Juan, me (5)</td>
                                                    <td>The following items were global inbox since you last checked it</td>
                                                    <td>Mar 1</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><span class="text-15"><i class="far fa-star"></i></span></td>
                                                    <td class="text-14">Hunter, me (3)</td>
                                                    <td>Yes ok, great! I'm not Stockholm anymore, we're making progress</td>
                                                    <td>Mar 1</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><span class="text-15"><i class="far fa-star"></i></span></td>
                                                    <td class="text-14">Jacob, me (1)</td>
                                                    <td><span class="badge bg-blue-ribbon text-white">Business</span> I'm not stuck in anymore, we're making progress.</td>
                                                    <td>Mar 3</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><span class="text-15"><i class="far fa-star"></i></span></td>
                                                    <td class="text-14">Kirby, me (5)</td>
                                                    <td>Hey Nicklas Sandell! storage space in Google Drive.</td>
                                                    <td>Mar 1</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="item-footer">
                                        <div class="row align-items-center">
                                            <div class="col-8">
                                                <div class="result-title">Showing 1 - 20 of 1,524</div>
                                            </div>
                                            <div class="col-4">
                                                <div class="pagination-btn">
                                                    <div class="btn-icon">
                                                        <a href="#" class="prev-btn"><i class="fas fa-angle-left"></i></a>
                                                        <a href="#" class="next-btn"><i class="fas fa-angle-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
